...
public class UTPageHitHelper {
        ...
        if (obj != null) {
            ...
            if (a2.isPageAppearCalled()) {
                ...
                if (refPage == null || refPage.length() == 0) {
                    refPage = WifiKeyParser.MESSAGE_SPLIT;
                }
    ...
    private static String b(Object obj) {
        ...
        return (simpleName == null || !simpleName.toLowerCase().endsWith(XuiSettingsManager.USER_SCENARIO_SOURCE_ACTIVITY)) ? simpleName : simpleName.substring(0, simpleName.length() - 8);
    }
}
