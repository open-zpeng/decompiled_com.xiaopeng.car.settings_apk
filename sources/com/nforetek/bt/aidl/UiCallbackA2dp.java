...
public interface UiCallbackA2dp extends IInterface {
    ...
    public static abstract class Stub extends Binder implements UiCallbackA2dp {
        ...
        public static UiCallbackA2dp asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof UiCallbackA2dp)) {
                return (UiCallbackA2dp) queryLocalInterface;
            }
