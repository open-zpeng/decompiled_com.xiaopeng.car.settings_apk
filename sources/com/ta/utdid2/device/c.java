...
public class c {
    ...
    private void d() {
        ...
        if (cVar != null) {
            if (i.m90a(cVar.getString("UTDID2"))) {
            ...
            boolean z = false;
            if (!i.m90a(this.b.getString("DID"))) {
                this.b.remove("DID");
                z = true;
            }
            if (!i.m90a(this.b.getString("EI"))) {
                this.b.remove("EI");
                z = true;
            }
            if (!i.m90a(this.b.getString("SI"))) {
                this.b.remove("SI");
                z = true;
            }
            if (z) {
    ...
    private void f(String str) {
        ...
        if (b(str)) {
            if (str.endsWith(WifiKeyParser.MESSAGE_END)) {
    ...
    private String g() {
        ...
        if (cVar != null) {
            ...
            if (i.m90a(string) || this.f197a.a(string) == null) {
                return null;
            }
            return string;
        }
