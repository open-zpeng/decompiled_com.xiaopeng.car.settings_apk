...
public class b {
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        C0021b c0021b = new C0021b(i3, new byte[(i2 * 3) / 4]);
        if (!c0021b.a(bArr, i, i2, true)) {
            throw new IllegalArgumentException("bad base-64");
        }
        if (c0021b.a == c0021b.b.length) {
            return c0021b.b;
        }
        byte[] bArr2 = new byte[c0021b.a];
        System.arraycopy(c0021b.b, 0, bArr2, 0, c0021b.a);
        return bArr2;
    }
            ...
            while (i9 < i4) {
                if (i8 == 0) {
                    while (true) {
                        ...
                        i7 = iArr[bArr[i9 + 3] & NfDef.AVRCP_PLAYING_STATUS_ID_ERROR] | (iArr[bArr[i9 + 1] & NfDef.AVRCP_PLAYING_STATUS_ID_ERROR] << 12) | (iArr[bArr[i9] & NfDef.AVRCP_PLAYING_STATUS_ID_ERROR] << 18) | (iArr[bArr[i9 + 2] & NfDef.AVRCP_PLAYING_STATUS_ID_ERROR] << 6);
                        if (i7 < 0) {
                            break;
                        }
                        bArr2[i6 + 2] = (byte) i7;
                ...
                int i11 = i9 + 1;
                int i12 = iArr[bArr[i9] & NfDef.AVRCP_PLAYING_STATUS_ID_ERROR];
                if (i8 != 0) {
                    if (i8 == 1) {
                        if (i12 < 0) {
                            if (i12 != -1) {
