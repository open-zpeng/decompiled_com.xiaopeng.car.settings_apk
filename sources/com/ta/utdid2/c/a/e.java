...
class e {
    ...
    public static final void a(byte[] bArr, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        for (byte b : bArr) {
            ...
            int i2 = b & NfDef.AVRCP_PLAYING_STATUS_ID_ERROR;
    ...
    public static final HashMap m96a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m97a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
        ...
        if (!name.equals("null")) {
            if (name.equals(TypedValues.Custom.S_STRING)) {
                ...
                if (name.equals(TypedValues.Custom.S_FLOAT)) {
                    ...
                    xmlPullParser.next();
                    int[] m97a = m97a(xmlPullParser, "int-array", strArr);
                    strArr[0] = attributeValue;
                    return m97a;
                } else if (name.equals("map")) {
                    xmlPullParser.next();
                    HashMap m96a = m96a(xmlPullParser, "map", strArr);
                    strArr[0] = attributeValue;
                    return m96a;
