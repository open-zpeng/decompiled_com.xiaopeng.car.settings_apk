...
public class DateUtils {
    ...
    private static SimpleDateFormat sTimeSimpleFormat = new SimpleDateFormat(DatetimeUtils.FORMAT_DATE_TIME_HOUR);
    private static SimpleDateFormat sBirthdaySimpleFormat = new SimpleDateFormat(DatetimeUtils.FORMAT_DATE_TIME_SHORT);
