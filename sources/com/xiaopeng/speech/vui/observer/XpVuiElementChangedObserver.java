...
public class XpVuiElementChangedObserver implements IXpVuiElementChanged {
    ...
    private void onVuiElementChanged(String str, View view, List<VuiElement> list, String[] strArr, int i) {
        ...
        if (this.mListener != null && !TextUtils.isEmpty(str)) {
            str = this.mListener.toString() + WifiKeyParser.MESSAGE_SPLIT + str;
        }
        if (view != null) {
        ...
        if (sceneCache != null) {
            List<VuiElement> cache = sceneCache.getCache(VuiEngineImpl.mSceneIdPrefix + WifiKeyParser.MESSAGE_SPLIT + str);
