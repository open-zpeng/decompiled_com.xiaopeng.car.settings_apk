...
public class SpeechVuiQuery extends SpeechQuery<ISpeechVuiQueryCaller> {
    ...
    public boolean isTableLayoutSelected(String str, String str2) {
        try {
            JSONObject jSONObject = new JSONObject(str2);
            return ((ISpeechVuiQueryCaller) this.mQueryCaller).isTableLayoutSelected(jSONObject.optInt("index", 0), jSONObject.optString("elementId", ""), jSONObject.optString(VuiConstants.SCENE_ID, ""), jSONObject.optString(VuiConstants.SCENE_PACKAGE_NAME, ""), jSONObject.optString("packageVersion", ""));
        } catch (JSONException e) {
            e.printStackTrace();
            return false;
        }
