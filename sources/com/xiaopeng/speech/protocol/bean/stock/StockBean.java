...
public class StockBean extends BaseBean {
    ...
    public void parseJson(JSONObject jSONObject) {
        if (jSONObject != null) {
            ...
            this.res = XuiSettingsManager.RET_SUCCESS;
    ...
    private String dateStrConvert(String str) {
        ...
        if (split2 == null || split2.length != 2 || (lastIndexOf = split2[1].lastIndexOf(WifiKeyParser.MESSAGE_SPLIT)) == -1 || lastIndexOf >= split2[1].length()) {
            return null;
        }
