...
public class PoiBean implements Parcelable {
    ...
    public static PoiBean fromJson(String str) {
        try {
            ...
            if (jSONObject.has(Config.External.ACTION_DEVICE_ADDRESS)) {
                poiBean.address = jSONObject.optString(Config.External.ACTION_DEVICE_ADDRESS);
            }
            ...
            if (jSONObject.has(Config.External.ACTION_DEVICE_FOUND_CATEGORY)) {
                poiBean.category = jSONObject.optInt(Config.External.ACTION_DEVICE_FOUND_CATEGORY);
            }
            ...
            if (jSONObject.has("naviLat")) {
                poiBean.naviLat = jSONObject.optDouble("naviLat", 0.0d);
            }
            if (jSONObject.has("typeCode")) {
                poiBean.typeCode = jSONObject.optString("typeCode");
            }
            if (jSONObject.has(BuriedPointUtils.SOURCE_KEY)) {
                poiBean.source = jSONObject.optString(BuriedPointUtils.SOURCE_KEY);
            }
    ...
    public JSONObject toJson() throws JSONException {
        ...
        jSONObject.put(Config.External.ACTION_DEVICE_ADDRESS, this.address);
        jSONObject.put("distance", this.distance);
        jSONObject.put("displayDistance", this.displayDistance);
        jSONObject.put("tel", this.telephone);
        jSONObject.put(Config.External.ACTION_DEVICE_FOUND_CATEGORY, this.category);
        ...
        jSONObject.put(BuriedPointUtils.SOURCE_KEY, this.source);
