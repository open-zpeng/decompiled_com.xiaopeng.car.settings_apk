...
public class XJumpButton extends XConstraintLayout {
    ...
    private void initView(int i, int i2) {
        ...
        if (i == 2) {
            ...
            if (i2 != -1) {
                this.xDrawablePaddingView = findViewById(R.id.x_space_drawable_padding);
                this.xDrawablePaddingView.setVisibility(0);
            }
            if (i == 0) {
        ...
        setForeground(ResourcesCompat.getDrawable(getResources(), R.color.x_tint_press, this.context.getTheme()));
