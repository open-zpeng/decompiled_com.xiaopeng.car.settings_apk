...
public abstract class AbsSlider extends XViewGroup implements IVuiElementListener {
    ...
    private void initView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mHeight = obtainStyledAttributes.getLayoutDimension(R.styleable.XSlider_android_layout_height, 0);
        setWorkableTotalLength(this.mWidth, this.mHeight);
        ...
        this.indicatorValue = this.initIndex - this.startIndex;
    ...
    public void stickIndicator() {
        ...
        int i = this.workableTotalLength / (this.endIndex - this.startIndex);
        this.mProgressViewLength = (((int) (((this.mProgressViewLength - 16.0f) / i) + 0.5d)) * i) + 16;
    }
