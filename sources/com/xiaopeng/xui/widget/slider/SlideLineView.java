...
public class SlideLineView extends XView {
    ...
    public SlideLineView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mXViewDelegate.getThemeViewModel().setCallback(new ThemeViewModel.OnCallback() { // from class: com.xiaopeng.xui.widget.slider.-$$Lambda$SlideLineView$xXR7LZYT_54TGyx1qFjkRa_CZFs
    ...
    public void setTickMark(Drawable drawable) {
        ...
        Drawable drawable3 = this.mTickMarkDr;
        if (drawable3 != null) {
    ...
    private void readStyleAttrs(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mColorRes = obtainStyledAttributes.getResourceId(R.styleable.SlideLineView_slider_tickMark_color, 0);
        int i2 = this.mColorRes;
        if (i2 != 0) {
            this.mTickMarkColor = ContextCompat.getColorStateList(context, i2);
        }
