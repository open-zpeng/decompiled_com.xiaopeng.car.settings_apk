...
public class ThemeController {
    ...
    private void resetViewStateIfNeed(boolean z, Uri uri) {
        ...
        if (Settings.Secure.getUriFor("ui_night_mode").equals(uri)) {
            this.mViewState = -1;
        }
    }
    ...
    public void readThemeSettings() {
        ...
        this.mThemeState = Settings.Secure.getInt(contentResolver, "key_theme_type", 0);
        this.mDaynightMode = Settings.Secure.getInt(contentResolver, "ui_night_mode", 0);
