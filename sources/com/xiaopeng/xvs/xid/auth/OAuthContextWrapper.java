...
public final class OAuthContextWrapper implements IWrapper {
    ...
    public void getAuthToken(Account account, String str, final ICallback<String, IException> iCallback, Handler handler) {
        ...
        this.mAccountManager.getAuthToken(account, str, bundle, false, new AccountManagerCallback() { // from class: com.xiaopeng.xvs.xid.auth.-$$Lambda$OAuthContextWrapper$VPa0oC9gL0p8P6TB7bq0BJgqjTI
