...
class AccountContextWrapper implements IWrapper {
    ...
    public void login(final Activity activity) {
        this.mAccountManager.addAccount("com.xiaopeng.accountservice.ACCOUNT_TYPE_XP_VEHICLE", null, null, null, null, new AccountManagerCallback() { // from class: com.xiaopeng.xvs.xid.account.-$$Lambda$AccountContextWrapper$9vWxSQvJjSzX9ZBhVU4sZBZazzw
