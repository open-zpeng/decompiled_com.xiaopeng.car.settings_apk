...
public final class SyncValueTable extends Settings.NameValueTable {
    ...
    public SyncValueTable(Application application, String str) {
        ...
        this.mAppID = str;
        this.mExtras.putString(ISync.EXTRA_NAME_APP_ID, str);
    ...
    public String getCashier(String str, String str2) {
        L.d(TAG, "getCashier() called with: key = [" + str + "]");
        try {
            this.mExtras.putString(ISync.EXTRA_NAME_KEY, str);
            Bundle call = this.mResolver.call(ISync.SYNC_CONTENT_URI, str2, this.mAppID, this.mExtras);
            if (call != null) {
                return call.getString(ISync.EXTRA_NAME_VALUE);
            }
            return null;
