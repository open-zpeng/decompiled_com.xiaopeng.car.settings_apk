...
public class SyncProviderWrapper implements IWrapper {
    ...
    public class AnonymousClass1 implements ICallback<SyncType, IException> {
        ...
        public void onSuccess(final SyncType syncType) {
            ...
            if (SyncProviderWrapper.this.mListener != null) {
                SyncProviderWrapper.this.mMainHandler.post(new Runnable() { // from class: com.xiaopeng.xvs.xid.sync.-$$Lambda$SyncProviderWrapper$1$IhHdCRC_RXsL6AursmyIhF_VjlA
    ...
    public void setSyncChangedListener(OnSyncChangedListener onSyncChangedListener, boolean z) {
        ...
        if (z && this.mSyncModule.isInit()) {
            ...
            this.mMainHandler.post(new Runnable() { // from class: com.xiaopeng.xvs.xid.sync.-$$Lambda$SyncProviderWrapper$2rPqYh1bvN0XaUucAsN8P-ONZBg
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public String getCashier(String str, String str2, String str3) {
        String cashier = this.mSyncModule.getCashier(str, str2);
        L.d(TAG, "getCashier() called with: key = [" + str + "], result = [" + cashier + "], defaultValue = [" + str3 + "]");
        return TextUtils.isEmpty(cashier) ? str3 : cashier;
    }
}
