...
public class SyncProviderImpl extends IClient implements ISync {
    ...
    private SyncProviderImpl() {
        ...
        this.mContextWrapper = new SyncProviderWrapper(XId.getApplication());
        this.mCarControlSync = new CarControlSyncImpl(this.mContextWrapper);
        this.mAiAssistantSync = new AiAssistantSyncImpl(this.mContextWrapper);
        this.mCarCameraSync = new CarCameraSyncImpl(this.mContextWrapper);
        this.mCarDvrSync = new CarDvrSyncImpl(this.mContextWrapper);
        this.mCarSettingsSync = new CarSettingsSyncImpl(this.mContextWrapper);
        this.mCarDemoSync = new CarDemoSyncImpl(this.mContextWrapper);
    }
    ...
    public int getCurrentHabitSum() {
        return Integer.parseInt(this.mContextWrapper.getCashier(ISync.SYNC_CALL_METHOD_GET_CASHIER_HABIT_SUM, ISync.SYNC_CALL_CASHIER_KEY_GET, "0"));
    }
