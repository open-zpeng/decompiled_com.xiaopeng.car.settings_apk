...
public class ExternalBluetoothDeviceInfo {
    ...
    public ExternalBluetoothDeviceInfo(String str, String str2) {
        this.deviceName = "";
        this.deviceAddr = "";
    ...
    public String toString() {
        return "ExternalBluetoothDeviceInfo{deviceName='" + this.deviceName + "', deviceAddr='" + this.deviceAddr + "', category=" + this.category + ", isConnectingBusy=" + this.isConnectingBusy + ", isDisconnectingBusy=" + this.isDisconnectingBusy + ", connectStatus=" + this.connectStatus + '}';
    }
}
