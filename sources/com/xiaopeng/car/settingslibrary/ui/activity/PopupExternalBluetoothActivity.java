...
public class PopupExternalBluetoothActivity extends PopupActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        Logs.d("xppopup external-blue onCreate ");
        show(Config.BACK_SEAT_BLUETOOTH);
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Logs.d("xppopup external-blue onDestroy ");
    }
}
