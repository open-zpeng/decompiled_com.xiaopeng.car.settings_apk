...
public class CinemaAnimInfo extends AnimInfo {
    ...
    public void onSizeChanged(int i, int i2) {
        ...
        int i3 = (-this.infoBitmap.getHeight()) / 2;
        this.mSrcRect = new Rect(0, 0, this.infoBitmap.getWidth(), this.infoBitmap.getHeight());
        this.mDestRect = new Rect(0, i3, this.infoBitmap.getWidth() + 0, this.infoBitmap.getHeight() + i3);
        this.mValueAnimator = ValueAnimator.ofFloat(1.0f, 0.25f);
        this.mValueAnimator.setDuration(2000L);
        this.mValueAnimator.setInterpolator(new AccelerateDecelerateInterpolator());
        this.mValueAnimator.setRepeatCount(-1);
        this.mValueAnimator.setRepeatMode(2);
        this.mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.car.settingslibrary.ui.widget.anim.CinemaAnimInfo.1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                CinemaAnimInfo.this.infoScale = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            }
        });
